...
.controller('getQuizCtrl',function($scope, $rootScope, $http, $document, $location, $state, datainmongo){
    ...
    $scope.startQuiz = function(){
        ...
        $http.post(datainmongo +'/getquizes',{paper:$scope.select.selectedPaper}).then(function(data)
        {
    ...
    $scope.nextQuestion = function() {
      ...
      if(($scope.selectedOption.option.toString())=== $scope.quiz.rightAnswer){
       ...
       if(($scope.QuestionNo) == $scope.questionArray.length){
                  ...
                  $http.post(datainmongo + '/saveResult',{userName: userName, quizTopic:$scope.select.selectedPaper, userID: id, riteans_perc: per}).then(function(data){
    ...
    $scope.noResult = false;
      ...
      $http.post(datainmongo +'/showResult',{userID:id}).then(function(data){
